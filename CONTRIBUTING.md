...
5.  From your branch, make a pull request against `CMSGov/ab2d-properties/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `CMSGov/ab2d-properties/main`
...
ab2d-properties will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
ab2d-properties uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/CMSGov/ab2d-properties/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of ab2d-properties. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of ab2d-properties:
...
[proj-releases-new]: https://github.com/CMSGov/ab2d-properties/releases/new
-->
...
docs. Please file an [issue](https://github.com/CMSGov/ab2d-properties/issues).
-->
